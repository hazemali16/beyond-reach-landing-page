...
const Hero = () => {
  ...
  <div className="pt-32 bg-[var(--first-color)] h-screen flex items-center justify-center gap-20 opacity-0 duration-500" id="hero">
    <div className="w-2/5 overflow-hidden max-md:w-11/12">
        ...
        <p className="text-white text-lg leading-relaxed duration-700 translate-y-[200px] delay-1000 max-sm:text-base">حلول تسويقية مبتكرة تعتمد على البيانات الضخمة لتحقيق أفضل النتائج بيوند ريتش هي وكالة تسويق تعمل على تحويل تحديات التسويق الرقمي إلى فرص نمو ونجاح ونتائج موثوقة
