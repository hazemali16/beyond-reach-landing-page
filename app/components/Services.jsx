...
const Services = () => {
  return (
  <div className="w-10/12 flex justify-center gap-12 items-center mx-auto opacity-0 duration-500 translate-y-10 max-sm:w-11/12 max-lg:flex-col-reverse" id="services">
    ...
    نحن في بيوند ريتش نعتبر التسويق األدائي هو قلب خدماتنا.
باستخدام استراتيجيات مبتكرة وتحليالت دقيقة، نحقق نتائج قابلة للقياس ونقدم عائد استثماري ملموس من الحمالت
التسويقية األدائية الفريدة.
    </p>
    </div>
